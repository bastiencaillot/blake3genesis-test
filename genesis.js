...
var defaults = {
    ...
    timestamp: "CNBC Aug 24 2021 Chinese tech stocks rally as JD.com and Alibaba surge nearly 9%",
    //the first value of the nonce that will be incremented when searching the genesis hash
    nonce: 1,
    //the PoW algorithm: Blake3
    algorithm: 'Blake3',
...
require('yargs')
    ...
    .command('*', 'create genesis block', () => { }, (argv) => {
        ...
        var merkle_root = $.blake3d_hash(createTx(options));
...
function PoW(data, options) {
    ...
    while (true) {
        ...
        var hash = $.reverseBuffer(blake3.hash(data)).toString('hex');
